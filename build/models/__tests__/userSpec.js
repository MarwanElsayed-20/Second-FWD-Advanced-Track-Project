...
describe("user models", function () {
    describe("test methods existence ", function () {
        ...
        it("should have a authenticate function", function () {
        ...
        describe("test user model logic", function () {
            ...
            it("create method should return a new user", function () { return __awaiter(void 0, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, shopUser.create({
                                firstName: "test2",
                                lastName: "user2",
                                password: "test2123",
                            })];
            ...
            it("index method should return all created users", function () { return __awaiter(void 0, void 0, void 0, function () {
                var users;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, shopUser.index()];
                        case 1:
                            users = _a.sent();
