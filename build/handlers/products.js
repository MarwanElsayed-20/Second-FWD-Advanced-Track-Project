...
var product = new product_1.ShopProduct();
// creat the create route
var create = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var authorizationHeader, token, newProduct, err_1;
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                res.json(__assign({}, specificProduct));
                return [3 /*break*/, 3];
            case 2:
                err_3 = _a.sent();
                res.json(err_3);
